...
casper.thenOpen('http://www.aa.com/reservation/awardFlightSearchOptionsSubmit.do', {
  ...
  data: {
    ...
    'multiCitySearchParam[0].flightDateParams.travelMonth': moment(ISODate).format("M"),
    'multiCitySearchParam[0].flightDateParams.travelDay': moment(ISODate).format("DD"),
    ...
    'flightParams.flightDateParams.travelMonth': moment(ISODate).format("M"),
    'flightParams.flightDateParams.travelDay': moment(ISODate).format("DD"),
...
casper.waitUntilVisible("#ctnButton", function() {
